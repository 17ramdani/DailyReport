                ...
                <div class="card mb-5 mt-5">
                    ...
                    <div class="card-body">
                        <form action="{{ route('report.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" id="time" name="time" value="{{ \Carbon\Carbon::now()->timezone('Asia/Jakarta')->format('H:i') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="button" class="btn btn-primary float-right mt-3 mb-3 mr-3" id="add-row">Tambah
                                Baris</button>
                        </form>
                    </div>
                </div>
